...
public class Texture
{
	...
	/**
	 * Creates and loads a new texture from file using slick util. Must provide
	 * the file name and path from the main project directory - ie.
	 * "/res/textures/foo.png"
	 * 
	 * @param filePath
	 *            The file path pointing to the texture from the main project
	 *            directory.
	 */

	public Texture(String filePath)
	{
		this.filePath = System.getProperty("user.dir") + "/res/textures/"
				+ filePath;
	...
	{
		if (texture.getTextureID() < 0) LogHelper.printError("Failed to load texture.");
