...
public class Matrix4f
{
	...
	public Matrix4f rotate(Vector3f f)
	{
		...
		mX.m[0][3] = 0;
		mX.m[1][0] = 0;
		mX.m[1][1] = (float) Math.cos(angleX);
		mX.m[1][2] = -(float) Math.sin(angleX);
		mX.m[1][3] = 0;
		mX.m[2][0] = 0;
		mX.m[2][1] = (float) Math.sin(angleX);
		mX.m[2][2] = (float) Math.cos(angleX);
		mX.m[2][3] = 0;
		mX.m[3][0] = 0;
		mX.m[3][1] = 0;
		mX.m[3][2] = 0;
		...
		mY.m[0][0] = (float) Math.cos(angleY);
		mY.m[0][1] = 0;
		mY.m[0][2] = (float) -Math.sin(angleY);
		mY.m[0][3] = 0;
		mY.m[1][0] = 0;
		mY.m[1][1] = 1;
		mY.m[1][2] = 0;
		mY.m[1][3] = 0;
		mY.m[2][0] = (float) Math.sin(angleY);
		mY.m[2][1] = 0;
		mY.m[2][2] = (float) Math.cos(angleY);
		mY.m[2][3] = 0;
		mY.m[3][0] = 0;
		mY.m[3][1] = 0;
		mY.m[3][2] = 0;
		...
		mZ.m[0][0] = (float) Math.cos(angleZ);
		mZ.m[0][1] = (float) -Math.sin(angleZ);
		mZ.m[0][2] = 0;
		mZ.m[0][3] = 0;
		mZ.m[1][0] = (float) Math.sin(angleZ);
		mZ.m[1][1] = (float) Math.cos(angleZ);
		mZ.m[1][2] = 0;
		mZ.m[1][3] = 0;
		mZ.m[2][0] = 0;
		mZ.m[2][1] = 0;
...
//		m[3][3] = 1;
	...
	public Matrix4f mul(Matrix4f r)
	{
		...
		for (int i = 0; i < 4; i++)
		{
			for (int j = 0; j < 4; j++)
			{
				float f = m[i][0] * r.get(0, j) + m[i][1] * r.get(1, j)
	...
	public Vector3f mul(Vector3f f)
	{
		...
		return new Vector3f(x * m[0][0] + y * m[0][1] + z * m[0][2] + w
				* m[0][3], x * m[1][0] + y * m[1][1] + z * m[1][2] + w
				* m[1][3], x * m[2][0] + y * m[2][1] + z * m[2][2] + w
				* m[2][3]);
	}
